...
public class ChildrenRepository implements ChildrenDataSource {

    public static volatile ChildrenRepository INSTANCE;
    ...
    private ChildrenRepository(AppExecutors executors, Context context){
     ...
     * @return
     */
    public static ChildrenRepository getInstance(@NonNull AppExecutors appExecutors, @NonNull Context context){
        if(INSTANCE == null){
            synchronized (ChildrenRepository.class){
                if(INSTANCE == null){
                    INSTANCE = new ChildrenRepository(appExecutors, context);
                }
            }
        }
        return INSTANCE;
